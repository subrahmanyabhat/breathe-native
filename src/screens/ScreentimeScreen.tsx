...
const ss = StyleSheet.create({
  ...
  heroNum: { color: DARK.text, fontSize: 48, fontWeight: '300', letterSpacing: -2, fontVariant: ['tabular-nums'] as any },
  ...
  poolNum: { color: '#a48ee8', fontSize: 34, fontWeight: '300', letterSpacing: -1.5, fontVariant: ['tabular-nums'] as any },
