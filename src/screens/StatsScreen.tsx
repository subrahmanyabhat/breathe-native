...
const ss = StyleSheet.create({
  ...
  heroNum: { color: DARK.text, fontSize: 56, fontWeight: '300', letterSpacing: -2, lineHeight: 62, fontVariant: ['tabular-nums'] as any },
  ...
  pairNum: { fontSize: 38, fontWeight: '300', letterSpacing: -1.5, fontVariant: ['tabular-nums'] as any },
